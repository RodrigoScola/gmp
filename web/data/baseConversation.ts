...
import { ChatConversationType, ChatMessageType } from "@/types"
import { faker } from "@faker-js/faker"
import fs from "fs"

export const newMessage = (id: string, message: Partial<ChatMessageType>): ChatMessageType => {
	return {
		id,
...
export const newConversation = () => {
	let convo: ChatConversationType = {
		id: "123123123",
		users: [
			newUser({
