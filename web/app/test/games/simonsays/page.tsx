...
import { SimonGameState } from "@/types"
...
export default function SimonSaysPAGE() {
	...
	const [gameState, setGameState] = useState<SimonGameState>(SimonGameState.WAITING)
	...
	return (
		<div className="w-fit m-auto">
			...
			<div className="flex justify-center pt-12 self-center">
				{(gameState == SimonGameState.END || gameState == SimonGameState.PLAYING) && <button onClick={() => startGame()}>Restart</button>}
