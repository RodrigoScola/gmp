export default function GameCard(props) {
    return (<div {...props} className={`${props.isSelected ? "bg-blue shadow-lg" : "bg-gray-700"} rounded-lg ${props.className ? props.className : ""}  max-w-[300px] p-2  border-2 border-white bg-gray-600`}>
