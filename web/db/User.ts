import { ExtendedUser, Friend, ReturnUserType, User as UserType } from "@/types"
...
export const getUserByUsername = async (username: string): Promise<ReturnUserType> => {
...
export const newUser = (data?: Partial<UserType<ExtendedUser>> | undefined | null, baseOptions?: Partial<newUserOptions>): ReturnUserType => {
...
export const newFriend = (data?: Partial<Friend>, options?: Partial<newFriendOptions>): Friend => {
